...
type Command struct {
	...
	V  []int64           `protobuf:"varint,3,rep,name=v" json:"v,omitempty"`
}
...
func (this *Command) VerboseEqual(that interface{}) error {
	...
	if len(this.V) != len(that1.V) {
		return fmt.Errorf("V this(%v) Not Equal that(%v)", len(this.V), len(that1.V))
	}
	for i := range this.V {
		if this.V[i] != that1.V[i] {
			return fmt.Errorf("V this[%v](%v) Not Equal that[%v](%v)", i, this.V[i], i, that1.V[i])
		}
	}
	return nil
}
...
var fileDescriptorEpaxos = []byte{
	...
	,
}
