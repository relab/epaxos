...
func (t *TryPreAccept) Size() int {
	panic("trypreaccept size")
}
...
func (t *TryPreAccept) Unmarshal(rr io.Reader, size int) error {
	var wire byteReader
	var ok bool
...
func (t *PreAcceptReply) Size() int {
	return 57
}
...
func (t *PreAcceptReply) Unmarshal(wire io.Reader, size int) error {
	var b [57]byte
	var bs []byte
	bs = b[:57]
...
func (t *TryPreAcceptReply) Size() int {
	panic("trepreacceptreply size")
}
...
func (t *TryPreAcceptReply) Unmarshal(wire io.Reader, size int) error {
	var b [26]byte
	var bs []byte
	bs = b[:26]
...
func (t *CommitShort) Unmarshal(wire io.Reader, size int) error {
	var b [40]byte
	var bs []byte
	bs = b[:40]
...
func (t *PreAccept) Size() int {
	return 16 + 1 + (len(t.Command) * state.CmdSize()) + 24
}
...
func (t *PreAccept) Unmarshal(rr io.Reader, size int) error {
	var wire byteReader
	var ok bool
	if wire, ok = rr.(byteReader); !ok {
		wire = bufio.NewReader(rr)
...
func (t *PreAcceptOK) Unmarshal(wire io.Reader, size int) error {
	var b [4]byte
	var bs []byte
	bs = b[:4]
...
func (t *PrepareReply) Size() int {
	panic("prepare reply size")
}
...
func (t *PrepareReply) Unmarshal(rr io.Reader, size int) error {
	var wire byteReader
	var ok bool
	if wire, ok = rr.(byteReader); !ok {
		wire = bufio.NewReader(rr)
...
func (t *Commit) Size() int {
	return 12 + 1 + (len(t.Command) * state.CmdSize()) + 24
}
...
func (t *Commit) Unmarshal(rr io.Reader, size int) error {
	var wire byteReader
	var ok bool
	if wire, ok = rr.(byteReader); !ok {
		wire = bufio.NewReader(rr)
...
func (t *AcceptReply) Unmarshal(wire io.Reader, size int) error {
	var b [13]byte
	var bs []byte
	bs = b[:13]
...
func (t *Accept) Unmarshal(wire io.Reader, size int) error {
	var b [44]byte
	var bs []byte
	bs = b[:44]
...
func (t *Prepare) Unmarshal(wire io.Reader, size int) error {
	var b [16]byte
	var bs []byte
	bs = b[:16]
	if _, err := io.ReadAtLeast(wire, bs, 16); err != nil {
