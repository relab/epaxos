...
/*
func (t *Propose) Size() int {
	return 4 + state.CmdSize() + 8
}
...
func (t *Propose) Unmarshal(wire io.Reader, size int) error {
	var b [8]byte
	var bs []byte
	bs = b[:4]
	...
	t.Command.UnmarshalReader(wire, size)
	bs = b[:8]
...
func (t *BeaconReply) Unmarshal(wire io.Reader, size int) error {
	var b [8]byte
	var bs []byte
	bs = b[:8]
	if _, err := io.ReadAtLeast(wire, bs, 8); err != nil {
...
func (t *PingArgs) Unmarshal(wire io.Reader, size int) error {
	var b [1]byte
	var bs []byte
	bs = b[:1]
...
func (t *BeTheLeaderArgs) Size() int {
	return 0
}
...
func (t *BeTheLeaderArgs) Unmarshal(wire io.Reader, size int) error {
	return nil
}

/*
func (t *ProposeAndRead) Size() int {
	return 4 + state.CmdSize() + state.KeySize()
}
...
func (t *ProposeAndRead) Unmarshal(wire io.Reader, size int) error {
	var b [4]byte
	var bs []byte
	bs = b[:4]
	if _, err := io.ReadAtLeast(wire, bs, 4); err != nil {
...
func (t *Read) Size() int {
	return 4 + state.KeySize()
}
...
func (t *Read) Unmarshal(wire io.Reader, size int) error {
	var b [4]byte
	var bs []byte
	bs = b[:4]
	if _, err := io.ReadAtLeast(wire, bs, 4); err != nil {
...
func (t *PingReply) Unmarshal(wire io.Reader, size int) error {
	return nil
}

func (t *Beacon) Size() int {
	return 8
}
...
func (t *Beacon) Unmarshal(wire io.Reader, size int) error {
	var b [8]byte
	var bs []byte
	bs = b[:8]
	if _, err := io.ReadAtLeast(wire, bs, 8); err != nil {
...
/*
func (t *ReadReply) Size() int {
	return 4 + state.ValueSize()
}
...
func (t *ReadReply) Unmarshal(wire io.Reader, size int) error {
	var b [4]byte
	var bs []byte
	bs = b[:4]
	if _, err := io.ReadAtLeast(wire, bs, 4); err != nil {
...
func (t *ProposeAndReadReply) Size() int {
	return 1 + 4 + state.ValueSize()
}
...
func (t *ProposeAndReadReply) Unmarshal(wire io.Reader, size int) error {
	var b [5]byte
	var bs []byte
	bs = b[:5]
...
func (t *ProposeReply) Unmarshal(wire io.Reader, size int) error {
	var b [5]byte
	var bs []byte
	bs = b[:5]
	if _, err := io.ReadAtLeast(wire, bs, 5); err != nil {
...
func (t *BeTheLeaderReply) Size() int {
	return 0
}
...
func (t *BeTheLeaderReply) Unmarshal(wire io.Reader, size int) error {
	return nil
}

/*
func (t *ProposeReplyTS) Size() int {
	return 1 + 4 + state.ValueSize() + 8
}
...
func (t *ProposeReplyTS) Unmarshal(wire io.Reader, size int) error {
	var b [8]byte
	var bs []byte
	bs = b[:5]
	if _, err := io.ReadAtLeast(wire, bs, 5); err != nil {
